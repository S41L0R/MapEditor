const t = new Uint8Array( [ 0 ] ), e = [ 171, 75, 84, 88, 32, 50, 48, 187, 13, 10, 26, 10 ]; var n, i, s, a, r, o, l, f; ! function ( t ) {
...
const u = { keepWriter: ! 1 }; function y( n, s = {} ) {
	...
	const r = []; let o = n.keyValue; s.keepWriter || ( o = x( {}, n.keyValue, { KTXwriter: 'KTX-Parse v0.0.5' } ) ); for ( const e in o ) {
...
export { U as KTX2Container, p as read, y as write };
