...
var BASIS = ( function () {
	...
	return (
		function ( BASIS ) {
			...
			var Module = typeof BASIS !== 'undefined' ? BASIS : {}; var readyPromiseResolve, readyPromiseReject; Module[ 'ready' ] = new Promise( function ( resolve, reject ) {
			...
			var UTF8Decoder = typeof TextDecoder !== 'undefined' ? new TextDecoder( 'utf8' ) : undefined; function UTF8ArrayToString( heap, idx, maxBytesToRead ) {
			...
			var INITIAL_MEMORY = Module[ 'INITIAL_MEMORY' ] || 16777216; var wasmTable; var __ATPRERUN__ = []; var __ATINIT__ = []; var __ATMAIN__ = []; var __ATPOSTRUN__ = []; var runtimeInitialized = false; function preRun() {
			...
			function createWasm() {
				...
				var info = { 'a': asmLibraryArg }; function receiveInstance( instance, module ) {
					...
					var exports = instance.exports; Module[ 'asm' ] = exports; wasmMemory = Module[ 'asm' ][ 'H' ]; updateGlobalBufferAndViews( wasmMemory.buffer ); wasmTable = Module[ 'asm' ][ 'I' ]; removeRunDependency( 'wasm-instantiate' );
