...
$jscomp.polyfill( 'Promise', function ( f ) {
	...
	m.prototype.executeBatch_ = function () {
		...
		for ( ;this.batch_ && this.batch_.length; ) {
			...
			var e =
this.batch_; this.batch_ = []; for ( var l = 0; l < e.length; ++ l ) {
	...
	h.prototype.resolveTo_ = function ( e ) {
		...
		if ( e === this ) this.reject_( new TypeError( 'A Promise cannot resolve to itself' ) ); else if ( e instanceof h ) this.settleSameAsPromise_( e ); else {
			...
			a:switch ( typeof e ) {
				...
				case 'object':var l = null != e; break a; case 'function':l = ! 0; break a; default:l = ! 1;
	...
	h.all = function ( e ) {
		...
		var f = $jscomp.makeIterator( e ), m = f.next(); return m.done ? v( [] ) : new h( function ( e, h ) {
			...
			var t = [], z = 0; do t.push( void 0 ), z ++, v( m.value ).callWhenSettled_( l( t.length - 1 ), h ), m = f.next(); while ( ! m.done );
		...
		function h( a, c, b ) {
			...
			var d = c + b; for ( b = c; a[ b ] && ! ( b >= d ); )++ b; if ( 16 < b - c && a.subarray && xa ) return xa.decode( a.subarray( c, b ) ); for ( d = ''; c < b; ) {
				...
				var k = a[ c ++ ]; if ( k & 128 ) {
					...
					var e = a[ c ++ ] & 63; if ( 192 == ( k & 224 ) )d += String.fromCharCode( ( k &
31 ) << 6 | e ); else {
		...
		function ba() {
			...
			if ( ! ba.strings ) {
				...
				var a = { USER: 'web_user',
						LOGNAME: 'web_user', PATH: '/', PWD: '/', HOME: '/home/web_user', LANG: ( 'object' === typeof navigator && navigator.languages && navigator.languages[ 0 ] || 'C' ).replace( '-', '_' ) + '.UTF-8', _: na }, c; for ( c in Aa )a[ c ] = Aa[ c ]; var b = []; for ( c in a )b.push( c + '=' + a[ c ] ); ba.strings = b;
		...
		function N( a, c ) {
			...
			var b = u( c ), d = b[ a ]; if ( d ) return d; d = Object.create( ( c || p ).prototype ); d.ptr = a; return b[ a ] = d;
...
this;
		...
		m = m || {}; var a = 'undefined' !== typeof m ? m : {}, Ga = ! 1, Ha = ! 1; a.onRuntimeInitialized = function () {
		...
		var ha = {}, W; for ( W in a )a.hasOwnProperty( W ) && ( ha[ W ] = a[ W ] ); var na = './this.program',
			ea = ! 1, Z = ! 1, oa = ! 1, fb = ! 1, Ia = ! 1; ea = 'object' === typeof window; Z = 'function' === typeof importScripts; oa = ( fb = 'object' === typeof process && 'object' === typeof process.versions && 'string' === typeof process.versions.node ) && ! ea && ! Z; Ia = ! ea && ! oa && ! Z; var M = '', pa, qa; if ( oa ) {
...
( na = process.argv[ 1 ].replace( /\\/g, '/' ) ); process.argv.slice( 2 ); process.on( 'uncaughtException', function ( a ) {
		...
		console.warn = console.error = 'undefined' !== typeof printErr ? printErr : print ); else if ( ea || Z )Z ? M = self.location.href : document.currentScript && ( M = document.currentScript.src ), f && ( M = f ), M = 0 !== M.indexOf( 'blob:' ) ? M.substr( 0, M.lastIndexOf( '/' ) + 1 ) : '', ra = function ( a ) {
			...
			a.wasmMemory : new WebAssembly.Memory( { initial: Ja / 65536 } ) ) var ka = ia.buffer; Ja = ka.byteLength; l( ka ); P[ 3416 ] = 5256704; var Fa = [], Ca = [], Da = [], Ea = [], Ba = ! 1, aa = 0, sa = null, ja = null; a.preloadedImages = {}; a.preloadedAudios = {}; var U = 'draco_decoder.wasm'; va( U ) || ( U = v( U ) ); Ca.push( { func: function () {
			...
			get64: function () {
				...
				if ( 2147418112 < a ) return ! 1; for ( var c = Math.max( T.length, 16777216 ); c < a; )c = 536870912 >=
c ? e( 2 * c, 65536 ) : Math.min( e( ( 3 * c + 2147483648 ) / 4, 65536 ), 2147418112 ); a: {
				...
				( function () {
					...
					if ( da || 'function' !== typeof WebAssembly.instantiateStreaming || va( U ) || 'function' !== typeof fetch ) return b( c ); fetch( U,
...
function ( a ) {
	...
	var c = this.ptr; a && 'object' === typeof a && ( a = a.ptr ); return Tb( c, a );
		...
		r.prototype = Object.create( p.prototype ); r.prototype.constructor = r; r.prototype.__class__ = r; r.__cache__ = {}; a.MetadataQuerier = r; r.prototype.HasEntry = r.prototype.HasEntry = function ( a, b ) {
			...
			var c = this.ptr; n.prepare(); a && 'object' === typeof a && ( a = a.ptr ); b = b && 'object' === typeof b ? b.ptr : V( b ); return !! Wb( c,
				a, b );
		...
		r.prototype.GetDoubleEntry = r.prototype.GetDoubleEntry = function ( a, b ) {
			...
			var c = this.ptr; n.prepare(); a && 'object' ===
typeof a && ( a = a.ptr ); b = b && 'object' === typeof b ? b.ptr : V( b ); return Zb( c, a, b );
		...
		r.prototype.GetEntryName = r.prototype.GetEntryName = function ( a, b ) {
			...
			var c = this.ptr; a && 'object' === typeof a && ( a = a.ptr ); b && 'object' ===
typeof b && ( b = b.ptr ); return X( bc( c, a, b ) );
...
g; g.prototype.__class__ = g; g.__cache__ = {}; a.Decoder = g; g.prototype.GetEncodedGeometryType = g.prototype.GetEncodedGeometryType = function ( a ) {
		...
		g.prototype.DecodeBufferToMesh = g.prototype.DecodeBufferToMesh = function ( a, b ) {
			...
			var c = this.ptr; a && 'object' === typeof a &&
( a = a.ptr ); b && 'object' === typeof b && ( b = b.ptr ); return N( oc( c, a, b ), x );
...
function ( a, b, d ) {
	...
	var c = this.ptr; n.prepare(); a && 'object' === typeof a && ( a = a.ptr ); b = b && 'object' === typeof b ? b.ptr : V( b ); d = d && 'object' === typeof d ? d.ptr : V( d ); return rc( c, a, b, d );
		...
		g.prototype.GetFaceFromMesh = g.prototype.GetFaceFromMesh = function ( a, b, d ) {
			...
			var c = this.ptr; a && 'object' === typeof a && ( a = a.ptr ); b && 'object' === typeof b && ( b = b.ptr ); d && 'object' ===
typeof d && ( d = d.ptr ); return !! wc( c, a, b, d );
...
function ( a, b, d ) {
	...
	var c = this.ptr; a && 'object' === typeof a && ( a = a.ptr ); b && 'object' === typeof b && ( b = b.ptr ); d && 'object' === typeof d && ( d = d.ptr ); return !! zc( c, a, b, d );
		...
		g.prototype.GetAttributeFloatForAllPoints = g.prototype.GetAttributeFloatForAllPoints = function ( a, b, d ) {
			...
			var c = this.ptr; a && 'object' === typeof a &&
( a = a.ptr ); b && 'object' === typeof b && ( b = b.ptr ); d && 'object' === typeof d && ( d = d.ptr ); return !! Bc( c, a, b, d );
		...
		g.prototype.GetAttributeInt8ForAllPoints = g.prototype.GetAttributeInt8ForAllPoints = function ( a, b, d ) {
			...
			var c = this.ptr; a && 'object' === typeof a && ( a = a.ptr ); b && 'object' === typeof b &&
( b = b.ptr ); d && 'object' === typeof d && ( d = d.ptr ); return !! Dc( c, a, b, d );
		...
		g.prototype.GetAttributeInt16ForAllPoints = g.prototype.GetAttributeInt16ForAllPoints = function ( a, b, d ) {
			...
			var c = this.ptr; a && 'object' === typeof a && ( a = a.ptr ); b && 'object' === typeof b && ( b = b.ptr ); d && 'object' === typeof d &&
( d = d.ptr ); return !! Fc( c, a, b, d );
		...
		g.prototype.GetAttributeInt32ForAllPoints = g.prototype.GetAttributeInt32ForAllPoints = function ( a, b, d ) {
			...
			var c = this.ptr; a && 'object' === typeof a && ( a = a.ptr ); b && 'object' === typeof b && ( b = b.ptr ); d && 'object' === typeof d && ( d = d.ptr ); return !! Hc( c,
				a, b, d );
		...
		g.prototype.GetAttributeDataArrayForAllPoints = g.prototype.GetAttributeDataArrayForAllPoints = function ( a, b, d, e, f ) {
			...
			var c = this.ptr; a && 'object' === typeof a && ( a = a.ptr ); b && 'object' === typeof b && ( b = b.ptr ); d && 'object' === typeof d && ( d = d.ptr ); e && 'object' === typeof e &&
( e = e.ptr ); f && 'object' === typeof f && ( f = f.ptr ); return !! Jc( c, a, b, d, e, f );
